...
var (
	...
	DefaultUnitPrice                 = uint64(0)
	DefaultLowerBoundBaseFee         = uint64(0)
	DefaultUpperBoundBaseFee         = uint64(0)
	DefaultGasTarget                 = uint64(0)
	DefaultMaxBlockGasUsedForBaseFee = uint64(0)
	DefaultBaseFeeDenominator        = uint64(0)
